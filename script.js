...
const translations = {
  en: {
    ...
    "founder.p1": "I'm a third-year plumbing apprentice working around Lawrence. I also build websites and workflow systems for small businesses that need cleaner operations, not a pile of software.",
    ...
    "contact.areaValue": "Lawrence, MA, remote available",
  ...
  es: {
    ...
    "founder.p1": "Soy aprendiz de plomería de tercer año trabajando alrededor de Lawrence. También construyo sitios web y sistemas de flujo para negocios pequeños que necesitan operaciones más limpias, no una pila de software.",
    ...
    "contact.areaValue": "Lawrence, MA, disponible remoto",
